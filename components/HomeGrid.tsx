  ...
  return (
    <div className="bento-grid">
      ...
      <ExpandableCard
        id="hero"
        variant="gradient"
        className="card-dots col-span-2 row-span-2 flex flex-col justify-center min-h-[280px]"
        expandedContent={
      ...
      <ExpandableCard
        id="location"
        variant="teal"
        className="rings-decoration col-span-1 flex flex-col justify-center items-center text-center"
        expandedContent={
      ...
      <ExpandableCard
        id="tiktok"
        variant="coral"
        className="col-span-1 flex flex-col justify-center relative overflow-hidden"
        expandedContent={
      ...
      <ExpandableCard
        id="techStack"
        variant="teal"
        className="card-lines col-span-2"
        expandedContent={
      ...
      <ExpandableCard
        id="about"
        variant="light-teal"
        className="card-dots-dark col-span-1 row-span-2 flex flex-col justify-center"
        expandedContent={
      ...
      <ExpandableCard
        id="hackathon"
        variant="coral"
        className="card-spotlight col-span-2 flex flex-col justify-center relative overflow-hidden"
        expandedContent={
      ...
      <ExpandableCard
        id="mission"
        variant="light-coral"
        className="col-span-3 flex items-center relative overflow-hidden"
        expandedContent={
      ...
      <ExpandableCard
        id="emailCta"
        variant="gradient"
        className="card-shimmer col-span-1 flex flex-col justify-center items-center text-center"
        expandedContent={
