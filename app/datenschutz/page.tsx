    ...
    <div className="mx-auto max-w-[1200px] px-6 md:px-8 lg:px-12 py-20">
      ...
      <div className="max-w-2xl prose prose-invert">
        ...
        <div className="text-gray-300 leading-relaxed space-y-6">
          <div>
            <h3 className="text-xl font-semibold text-white mb-2">1. Datenschutz auf einen Blick</h3>
            <p className="text-sm">
          ...
          <div>
            <h3 className="text-xl font-semibold text-white mb-2">2. Hosting</h3>
            <p className="text-sm">
          ...
          <div>
            <h3 className="text-xl font-semibold text-white mb-2">3. Kontaktaufnahme</h3>
            <p className="text-sm">
          ...
          <div>
            <h3 className="text-xl font-semibold text-white mb-2">4. Deine Rechte</h3>
            <p className="text-sm">
